      ...
      <div className="flex flex-col w-screen h-screen overflow-y-hidden bg-gray-100 dark:bg-gray-900">
        ...
        <div className="mx-auto w-screen-90">
          <div className="flex flex-col w-full px-4 py-6">
            ...
            <div className="w-full my-4 bg-gray-200 rounded dark:bg-gray-700 h-screen-60" />
            <div className="w-full my-4 bg-white rounded opacity-75 dark:bg-gray-700 h-screen-60" />
          </div>
        </div>
      </div>
    );
