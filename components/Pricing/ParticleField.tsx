export default function ParticleField() {
  return (
    <>
      ...
      <span className="absolute block w-12 h-12 ml-8 bg-indigo-300 rounded-full lg:inset-1/3 particle-circle-two-animation" />
      <span className="absolute block w-10 h-10 -rotate-45 bg-indigo-400 rounded-sm -ml-36 lg:inset-y-2/3 lg:inset-x-2/3 particle-square-three-animation " />
